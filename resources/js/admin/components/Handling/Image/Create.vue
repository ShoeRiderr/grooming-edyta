        ...
        <div class="content">
            ...
            <div class="content-footer">
                <div class="footer-actions">
                    <button form="handling-image-form" type="submit" class="btn btn-primary">Dodaj zdjęcia</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        onSubmit(images) {
            ...
            axios.post(`/json/admin/handling/image`, data, {
                ...
                this.$router.push({ name: 'admin.handling.index' });
            }).catch((error) => {
